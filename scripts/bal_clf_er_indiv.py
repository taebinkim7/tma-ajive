...
for i in tqdm(range(10)):
    ...
    er_indiv_loadings = ajive.blocks['er'].individual.loadings_
    train_feats_er_indiv = train_feats_er @ er_indiv_loadings
    test_feats_er_indiv = test_feats_er @ er_indiv_loadings
    train_feats = train_feats_er_indiv
    test_feats = test_feats_er_indiv
